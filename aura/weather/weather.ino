...
#include "translations.h"  // also defines DEFAULT_CAPTIVE_SSID
...
#define TEMP_WAKEUP_TIMEOUT_MS 15000
...
static uint32_t display_brightness = DEFAULT_BRIGHTNESS;
...
// Large image + small icon for one weather condition
struct WeatherArt {
